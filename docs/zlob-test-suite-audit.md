...
| `test_rust_glob.zig` | No direct equivalent | Exercises zlob's filesystem glob API rather than Ferralk's matcher-only or Walker APIs; source scenarios inform future Walker fixtures. |
