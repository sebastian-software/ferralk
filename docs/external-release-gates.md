...
| --- | --- | --- |
| Courtesy notice to zlob maintainer | ADR-0001 records the independent-port intent and attribution; a reviewed, unsent [draft note](zlob-courtesy-note.md) is ready. | A maintainer-approved message sent to the upstream maintainer. |
