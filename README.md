...
1.0.1-rc.1 release line for applications. <!-- x-release-please-version -->

## Install

```toml
[dependencies]
ferralk = "1.0.1-rc.1" # x-release-please-version
ferralk-glob = "1.0.1-rc.1" # x-release-please-version
```
