...
crates.io; use the current 0.9.1 release line for applications. <!-- x-release-please-version -->

```toml
[dependencies]
ferralk = "0.9.1" # x-release-please-version
ferralk-glob = "0.9.1" # x-release-please-version
```
