...
crates.io; use the current 0.9.3 release line for applications. <!-- x-release-please-version -->

```toml
[dependencies]
ferralk = "0.9.3" # x-release-please-version
ferralk-glob = "0.9.3" # x-release-please-version
```
